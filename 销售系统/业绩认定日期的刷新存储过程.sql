USE [dotnet_erp60]
GO
/****** Object:  StoredProcedure [dbo].[PROC_S_UpdateRoomYeJi]    Script Date: 2024/11/29 17:30:32 ******/
SET ANSI_NULLS ON
GO
...
2  换房
2.1	 换房时间发生在今年，换出房间业绩认定日期为空，换入房间业绩认定日期为空，且回款>10%，则插入换入房间业绩认定记录
2.2	 换房时间发生在今年，换出房间业绩认定日期去年，换入房间业绩认定日期为空，且回款>10%，则换出不变，插入换入
2.3	 换房时间发生在今年，换出房间业绩认定日期去年，换入房间业绩认定日期今年，且回款>10%，则换出不变；换入作废历史，插入新的
2.4	 换房时间发生在今年，换出房间业绩认定日期去年，换入房间业绩认定日期去年，且回款>10%，则换出不变，换入不变
2.5	 换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期为空，且回款>10%，则换出作废，插入换入
2.6	 换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期去年，且回款>10%，则换出作废，换入不变
2.7	 换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期今年，且回款>10%，则换出作废；换入作废历史，插入新的
3 新签
...
--签约日期（网签日期）在2024年11月1日及以后，且项目所属公司在【城实公司、芳实公司、卓盈公司、湖南公司、安徽公司、侨房公司、城德公司、珠江建设】，回款比例要求在15%及以上，才算有效业绩。其它项目10%（保持不变）
delete from #hk where BUGUID IN ('709FCCC6-C47B-4761-9FBD-08DBA809E17C','8D97B491-D08B-4AA0-7A1F-08DC90A2FD61','1D716088-8A38-43FE-2CC6-08DCA05A50FA','F2F6996C-E6C9-4A2F-383F-08DCA05A50FA',
'44120972-185B-E411-902B-40F2E92B3FDD','2C8AFE08-EA4E-E611-B3D3-40F2E92B3FDD','DA9A38E3-0AAE-E511-B4AF-40F2E92B3FDD','71CAAFE7-05EF-4A82-A1C7-9F132AD1E6C3','0CFB9DDF-9A78-4CD3-AFDA-9E106C941376')
and RmbAmount/CjRmbTotal < 0.15;
...
--2  换房
--2.1  换房时间发生在今年，换出房间业绩认定日期为空，换入房间业绩认定日期为空，且回款>10%，则插入换入房间业绩认定记录
--2.2  换房时间发生在今年，换出房间业绩认定日期往年，换入房间业绩认定日期为空，且回款>10%，则换出不变，插入换入
--2.3  换房时间发生在今年，换出房间业绩认定日期往年，换入房间业绩认定日期今年，且回款>10%，则换出不变；换入作废历史，插入新的
--2.4  换房时间发生在今年，换出房间业绩认定日期往年，换入房间业绩认定日期去年，且回款>10%，则换出不变，换入不变
--2.5  换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期为空，且回款>10%，则换出作废，插入换入
--2.6  换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期去年，且回款>10%，则换出作废，换入不变
--2.7  换房时间发生在今年，换出房间业绩认定日期今年，换入房间业绩认定日期今年，且回款>10%，则换出作废；换入作废历史，插入新的
--
...
INNER JOIN s_Contract c1 on s.NewSaleGUID = c1.ContractGUID
...
SELECT
    ...
    '激活' AS x_zfbz -- 作废,激活
FROM #hf hf
WHERE (hf.OldRoomYeJiTime IS NULL AND hf.NewRoomYeJiTime IS NULL) 
OR (YEAR(hf.OldRoomYeJiTime) < YEAR(GETDATE()) AND hf.NewRoomYeJiTime IS NULL);
